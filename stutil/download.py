...
def _save_response_content(
    content: Iterator[bytes], destination: str, length: int=None, verbose: bool=False
) -> None:
...
def download_url(
    url: str, root: str, filename: str=None, max_redirect_hops: int=3
):
    ...
    Args:
        ...
        filename (str, optional): file name of the saved content. If None base name of the url will be used. Default: None.
