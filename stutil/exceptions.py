...
def warn_deprecated(name: str, favor_of: str=None, recommendation: str=None) -> None:
    ...
    warnings.warn(deprecation_text, FutureWarning)


def deprecated(favor_of: str=None, recommendation: str=None) -> Callable:
